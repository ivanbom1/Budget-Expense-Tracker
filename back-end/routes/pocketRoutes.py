...
pocket_bp.route('/pockets/<int:pocket_id>', methods=['GET'])(PocketController.get_pocket)
...
pocket_bp.route('/pockets/<int:pocket_id>', methods=['PUT'])(PocketController.update_pocket)
pocket_bp.route('/pockets/<int:pocket_id>', methods=['DELETE'])(PocketController.delete_pocket)